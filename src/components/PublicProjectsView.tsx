      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100/80 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5">
            {settings.app_logo ? (
              <img src={settings.app_logo} alt="" className="w-9 h-9 rounded-lg object-cover" />
            ) : (
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <div className="flex-1 flex justify-center lg:justify-end">
              <div className="relative">
                <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-3xl bg-gradient-to-br from-emerald-100 via-emerald-50 to-amber-50 flex items-center justify-center shadow-2xl shadow-emerald-200/50">
                  <svg className="w-40 h-40 text-emerald-600/80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1">
              <div className="relative">
                <div className="w-full aspect-square max-w-sm mx-auto rounded-3xl bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center">
                  <svg className="w-36 h-36 text-emerald-600/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="text-center sm:text-right">
              <div className="flex items-center justify-center sm:justify-start gap-3 mb-4">
                {settings.app_logo ? (
                  <img src={settings.app_logo} alt="" className="w-10 h-10 rounded-lg object-cover" />
                ) : (
