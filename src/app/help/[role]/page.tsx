  ...
  supervisor: {
    ...
    sections: [
        ...
        items: [
          ...
          },
          {
            ...
            subItems: [
              ...
              { label: 'تحميل Excel', detail: 'تصدير جميع الردود إلى ملف Excel.' },
            ]
          },
          {
            icon: icons.questions,
            label: 'أنواع الأسئلة',
            detail: 'جميع أنواع الأسئلة المتاحة عند إنشاء نموذج — نفس الشرح الموجود في دليل المتطوع مع إضافات للمشرف:',
            subItems: [
              { label: 'نص', detail: 'نص قصير — يمكن تحديد نقاط للسؤال.' },
              { label: 'نص طويل', detail: 'نص مطول — يمكن تحديد نقاط للسؤال.' },
              { label: 'اختيار واحد', detail: 'خيار واحد — لكل خيار نقاط منفصلة، وعداد (Counter) لحساب القيم.' },
              { label: 'اختيار متعدد', detail: 'عدة خيارات — لكل خيار نقاط منفصلة.' },
              { label: 'قائمة منسدلة', detail: 'قائمة — نوعان: اختيار واحد أو متعدد، مع تحديد الإجابة الصحيحة.' },
              { label: 'تقييم', detail: 'مقياس 1-10 — يمكن تحديد نقاط للسؤال.' },
              { label: 'ترتيب', detail: 'ترتيب حسب الأولوية — لكل خيار نقاط.' },
              { label: 'مصفوفة', detail: 'صفوف وأعمدة — لكل عمود نقاط، كل صف قد يكون مطلوباً أو اختيارياً.' },
              { label: 'تاريخ', detail: 'اختيار تاريخ — يمكن تحديد نقاط.' },
              { label: 'وقت', detail: 'اختيار وقت — يمكن تحديد نقاط.' },
              { label: 'رفع ملف', detail: 'رفع ملف أو صورة.' },
            ]
          },
          {
            icon: icons.star,
            label: 'خصائص كل سؤال',
            detail: 'عند إضافة سؤال في النموذج، تتوفر لك الخصائص التالية:',
            subItems: [
              { label: 'النص', detail: 'نص السؤال الذي يظهر للمتطوع.' },
              { label: 'مطلوب (*)', detail: 'تفعيل هذا الخيار يجعل السؤال إجبارياً.' },
              { label: 'النقاط', detail: 'تحديد عدد النقاط للسؤال. تظهر النقاط الإجمالية بجانب السؤال.' },
              { label: 'العداد (Counter)', detail: 'لأسئلة الاختيار الواحد: تفعيل العداد يضيف حقل "الهدف" لكل خيار لحساب قيمة رقمية.' },
              { label: 'الإجابة الصحيحة', detail: 'للقوائم المنسدلة: تحديد الإجابة/الإجابات الصحيحة.' },
              { label: 'ترتيب الخيارات', detail: 'يمكنك ترتيب الخيارات عن طريق السحب والإفلات، أو إضافة خيارات جماعية.' },
            ]
          },
        ]
      },
      {
        ...
        description: 'إنشاء وإدارة المناهج والدروس للمشاريع',
        items: [
          {
            icon: icons.star,
            label: 'إنشاء منهج',
            detail: 'يمكنك إضافة منهج دراسي لأي مشروع تشرف عليه. تختار العنوان، الوصف، ونوع التسلسل (تسلسلي أو مفتوح).',
            subItems: [
              { label: 'تسلسلي', detail: 'يجب إكمال كل درس قبل الانتقال للذي يليه.' },
              { label: 'مفتوح', detail: 'يمكن للمتطوع اختيار أي درس بشكل عشوائي.' },
            ]
          },
          {
            icon: icons.lessons,
            label: 'إضافة محتوى (دروس)',
            detail: 'بعد إنشاء المنهج، يمكنك إضافة محتوى تعليمي بنوعين:',
            subItems: [
              { label: 'فيديو', detail: 'رابط يوتيوب — يدعم المحتوى الواحد (سطر واحد) أو المتعدد (عدة أسطر مع إضافة المزيد).' },
              { label: 'صوت', detail: 'رابط صوتي — يدعم المحتوى الواحد أو المتعدد أيضاً.' },
              { label: 'نص', detail: 'محرر نصوص متكامل — محتوى واحد فقط مع عنوان ومحرر نصوص ووصف.' },
              { label: 'السماح بالتعليقات', detail: 'تفعيل/تعطيل التعليقات على كل درس.' },
            ]
          },
        ]
      },
        ...
        items: [
          ...
          },
          {
            ...
            subItems: [
              ...
              { label: 'تحميل Excel', detail: 'زر في صفحة تعديل النموذج لتصدير جميع الردود إلى ملف Excel.' },
            ]
          },
        ]
      },
